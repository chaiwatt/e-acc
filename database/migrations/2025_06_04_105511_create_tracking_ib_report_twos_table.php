...
class CreateTrackingIbReportTwosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tracking_ib_report_twos', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('tracking_ib_report_twos');
    }
}
