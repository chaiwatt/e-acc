...
class CreateTrackingCbReportTwosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tracking_cb_report_twos', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('tracking_cb_report_twos');
    }
}
