...
<input type="text" id="address_id">
    ...
    <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
        <label for="title" class="col-md-2 control-label">
            ชื่อเรื่อง : <span class="text-danger">*</span>
        </label>
        <div class="col-md-9">
    ...
    <div class="row">
        <div class="col-md-6">
                ...
                <div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
                     {{-- <button style="margin-bottom: 5px" type="button" class="btn btn-md btn-info" data-toggle="modal" data-target="#exampleModalAppointDepartment" style="width:100%;">
                            <i class="icon-plus"></i>&nbsp;เพิ่มที่อยู่                        </button> --}}

                    <label for="address" class="col-md-4 control-label">ที่อยู่หน่วยงาน :</label>
                    <div class="col-md-8">
                         <button style="margin-bottom: 5px" type="button" class="btn btn-md btn-info" data-toggle="modal" data-target="#exampleModalAppointDepartment" style="width:100%;">
                            <i class="icon-plus"></i>&nbsp;เพิ่มที่อยู่                        
                    </button>
                        <textarea id="address" name="address" rows="2" cols="45" class="form-control">{{ old('address') }}</textarea>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
                <div class="form-group {{ $errors->has('email') ? 'has-error' : ''}}">
                        {!! Html::decode(Form::label('email', 'อีเมล'.' : '.'<span class="text-danger">*</span>', ['class' => 'col-md-2 control-label'])) !!}
                        <div class="col-md-8">
