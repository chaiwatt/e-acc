    ...
    <script>
        ...
        const insertIbTemplate = () => {
            const templateData = {
                ...
                certificateNo: "21-IB0004",
                inspectionBodyName: "สำนักงานตำรวจแห่งชาติ สำนักงานพิสูจน์หลักฐานตำรวจ กองพิสูจน์หลักฐานกลาง กลุ่มตรวจอาวุธปืนและเครื่องกระสุนปืน",
                inspectionBodyAddress: "อาคาร 14 กองพิสูจน์หลักฐานกลาง ถนนอังรีดูนังต์ แขวงวังใหม่ เขตปทุมวัน กรุงเทพฯ",
                headOfficeAddress: "ที่ตั้งสำนักงานสาขา (กรณีแตกต่างจากที่ตั้งสำนักงานใหญ่)",
                accreditationNo: "หน่วยตรวจ 0050",
                inspectionBodyType: "ประเภท C",
                inspectionItems: [
                    {
                        category: "การตรวจอาวุธปืนและเครื่องกระสุนปืน",
                        procedure: "- การตรวจอาวุธปืนและเครื่องกระสุนปืน<br>- ตามพระราชบัญญัติอาวุธปืน เครื่องกระสุนปืน วัตถุระเบิด ดอกไม้เพลิง และสิ่งเทียมอาวุธปืน พ.ศ. 2490",
                        requirements: "ขั้นตอนการปฏิบัติงาน : วิธีการตรวจ หมายเลข STM-07-01 ถึง STM-07-05"
                    }
                ]
            };
            ...
            const templateHTML = `
                ...
                <table class="borderless" style="width: 100%; margin-bottom: 1em;">
                    <tbody>
                        <tr>
                            <td class="vertical-align-top" style="width: 35%;"><b>ชื่อหน่วยตรวจ</b></td>
                            <td class="vertical-align-top">: ${templateData.inspectionBodyName}</td>
                        </tr>
                        <tr>
                            <td class="vertical-align-top"><b>ที่ตั้งสถานประกอบการของหน่วยตรวจและข้อมูลติดต่อ</b></td>
                            <td class="vertical-align-top">: ${templateData.inspectionBodyAddress}</td>
                        </tr>
                        <tr>
                            <td class="vertical-align-top"><b>ที่ตั้งสำนักงานใหญ่</b></td>
                            <td class="vertical-align-top">: ${templateData.headOfficeAddress}</td>
                        </tr>
                        <tr>
