        ...
        <div class="modal-content">
            ...
            <div class="modal-input-group" style="display: flex; gap: 20px;">
                <div style="flex: 1;">
                    ...
                    <input type="text" id="lab-cal-field" style="font-family: 'thsarabunnew'; font-size:22px;width:200px">
                </div>
                <div style="flex: 1;">
                    <label for="lab-cal-instrument">เครื่องมือ:</label>
                    <input type="text" id="lab-cal-instrument" style="font-family: 'thsarabunnew'; font-size:22px;width:200px">
                </div>
            </div>
            <div class="modal-input-group" style="display: flex; gap: 20px;">
                <div style="flex: 1;">
                    <label for="lab-cal-parameter">พารามิเตอร์:</label>
                    <input type="text" id="lab-cal-parameter" style="font-family: 'thsarabunnew'; font-size:22px;width:200px">
                </div>
                <div style="flex: 1;">
                    <label for="lab-cal-condition">เงื่อนไขการวัด:</label>
                    <input type="text" id="lab-cal-condition" style="font-family: 'thsarabunnew'; font-size:22px;width:200px">
                </div>
            </div>
            <div class="modal-input-group" style="display: flex; gap: 20px;">
                <div style="flex: 1;">
                    <label for="lab-cal-param-details-editor">รายละเอียดพารามิเตอร์:</label>
                    <div id="lab-cal-param-details-editor" class="editable-div" style="font-family: 'thsarabunnew'; font-size:22px;width:180px" contenteditable="true"></div>
                </div>
                <div style="flex: 1;">
                    <label for="lab-cal-capability-editor">ขีดความสามารถฯ:</label>
                    <div id="lab-cal-capability-editor" class="editable-div" style="font-family: 'thsarabunnew'; font-size:22px;width:180px" contenteditable="true"></div>
                </div>
            </div>
            <!-- === END: MODIFICATION === -->
            <div class="modal-input-group">
    ...
    <div id="lab-test-item-modal" class="modal-overlay">
        <div class="modal-content" style="width: 550px">
            ...
            <div class="modal-input-group">
                ...
                <input type="text" id="lab-test-field" style="font-family: 'thsarabunnew'; font-size:22px;width:250px">
            </div>
            <div class="modal-input-group" style="display: flex; gap: 20px;">
                <div style="flex: 1;">
                    <label for="lab-test-parameter-editor">รายการทดสอบ:</label>
                    <div id="lab-test-parameter-editor" class="editable-div" style="font-family: 'thsarabunnew'; font-size:22px;width:250px" contenteditable="true"></div>
                </div>
                <div style="flex: 1;">
                    <label for="lab-test-method-editor">วิธีทดสอบ:</label>
                    <div id="lab-test-method-editor" class="editable-div" style="font-family: 'thsarabunnew'; font-size:22px;width:250px" contenteditable="true"></div>
                </div>
            </div>
            <!-- === END: MODIFICATION === -->
            <div class="modal-buttons">
...
const insertCbTemplate = () => {
   ...
   const insertIbTemplate = () => {
        ...
        document.getElementById('add-lab-test-item-btn').addEventListener('click', () => {
            ...
            const parameterLines = labTestParameterEditorExtractor.getLines();
            const parameter = parameterLines.join('<br>');
            const methodLines = labTestMethodEditorExtractor.getLines();
            const method = methodLines.join('<br>');

            if (!field && !parameter.trim() && !method.trim()) {
