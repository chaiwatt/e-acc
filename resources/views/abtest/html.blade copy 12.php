        ...
        <div class="modal-content">
            ...
            <div class="modal-input-group" style="display: flex; gap: 20px;">
                <div style="flex: 1;">
                    ...
                    <input type="text" id="lab-cal-field" style="font-family: 'thsarabunnew'; font-size:22px;;width:220px">
                </div>
                <div style="flex: 1;">
                    <label for="lab-cal-instrument">เครื่องมือ:</label>
                    <input type="text" id="lab-cal-instrument" style="font-family: 'thsarabunnew'; font-size:22px;;width:220px">
                </div>
            </div>
            ...
            <div class="modal-input-group" style="display: flex; gap: 20px;">
                <div style="flex: 1;">
                    ...
                    <input type="text" id="lab-cal-parameter" style="font-family: 'thsarabunnew'; font-size:22px;;width:220px">
                </div>
                <div style="flex: 1;">
                    <label for="lab-cal-condition">เงื่อนไขการวัด:</label>
                    <input type="text" id="lab-cal-condition" style="font-family: 'thsarabunnew'; font-size:22px;;width:220px">
                </div>
            </div>
            ...
            <div class="modal-input-group" style="display: flex; gap: 20px;">
                <div style="flex: 1;">
                    ...
                    <div id="lab-cal-param-details-editor" class="editable-div" style="font-family: 'thsarabunnew'; font-size:22px;width:220px" contenteditable="true"></div>
                </div>
                <div style="flex: 1;">
                    <label for="lab-cal-capability-editor">ขีดความสามารถฯ:</label>
                    <div id="lab-cal-capability-editor" class="editable-div" style="font-family: 'thsarabunnew'; font-size:22px;width:220px" contenteditable="true"></div>
                </div>
            </div>
            <!-- === END: MODIFICATION === -->
            <div class="modal-input-group">
                <label for="lab-cal-method-editor" style="display: block;">วิธีสอบเทียบ / มาตรฐานที่ใช้:</label>
                <div id="lab-cal-method-editor" class="editable-div" style="font-family: 'thsarabunnew'; font-size:22px;width:220px" contenteditable="true"></div>
            </div>
            <div class="modal-buttons">
