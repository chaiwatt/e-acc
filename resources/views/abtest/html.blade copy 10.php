...
const insertCbTemplate = () => {
   ...
   const insertIbTemplate = () => {
        ...
        // --- [แก้ไข] Logic for adding Lab Cal item ---
        document.getElementById('add-lab-cal-item-btn').addEventListener('click', () => {
            ...
            const method = document.getElementById('lab-cal-method').value.trim();
            ...
            if (capability) {
                ...
                // Use the user's more complex line break logic for this field
                if (cells[2].textContent.trim()) {
                    const prefix = condition ? '<br><br><br>' : '<br><br>';
                    cells[2].innerHTML += prefix + formattedCapability;
                } else {
                    cells[2].innerHTML = capability; // No indent for the first item
                }
            }
            ...
            if (method) {
                ...
                // Use the standard appendToCell for clean, single line breaks on append
                appendToCell(cells[3], formattedMethod);
            }
