                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                {{-- <button type="button" id="btn_add_cb_scope_isic_isic" class="btn btn-success">
                                 ...
                                 <a href="{{route('certify.applicant-cb.cb-scope-editor')}}" id="scope-editor" target="_blank" class="view-attach btn btn-info btn-sm" style="margin-bottom:5px">แก้ไขขอบข่าย</a> 
