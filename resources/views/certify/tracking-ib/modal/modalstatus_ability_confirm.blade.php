            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        ...
                        <p style="text-indent: 50px;">ตามที่  {{$applicant->name_unit}} ได้แจ้งขอรับบริการการตรวจประเมินความสามารถ 
                                    ...
                                    <span style="display: inline-block; width: 805px; border-bottom: 1px dotted #000; margin-left: 10px;">
                                        <span style="opacity: 0.5;">
                                            ...
                                            @if ($applicant->address_street !== null) ถนน{{$applicant->address_street}}  @endif
                                                 ...
                                                 @if (strpos($applicant->BasicProvince->PROVINCE_NAME, 'กรุงเทพ') !== false)
                                                    แขวง {{$applicant->district_id}} เขต{{$applicant->amphur_id }} {{$applicant->BasicProvince->PROVINCE_NAME}}
                                                @else
                                                    ตำบล{{$applicant->district_id}}  อำเภอ{{$applicant->amphur_id }}  จังหวัด{{$applicant->BasicProvince->PROVINCE_NAME}}
                                                @endif 
...
// return;
                ...
                // เรียก AJAX
                fetch("{{route('tracking-ib.ability-confirm')}}", {
                    method: "POST",
                    headers: {
