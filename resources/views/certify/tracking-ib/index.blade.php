                                                  ...
                                                  <td>
                                                                            ...
                                                                            <div class="modal-dialog " role="document">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body"> 
                                                                                        ...
                                                                                        {{-- {{$item->certificate_export_to->applications }} --}}
                                                                                        <div class="form-group" style="margin-top: 25px">
                                                                                            <div class="row">
                                                                                                <div class="col-sm-12" >
                                                                                                    <a href="{{ url('/certify/applicant-ib/' . $item->certificate_export_to->certiIB->token . '/edit') }}"  title="Edit ApplicantIB" class="btn btn-primary">
                                                      ...
                                                      @elseif($item->status_id == 3)
                                                       ...
                                                       @elseif($item->status_id == 5  && !Is_null($item->tracking_inspection_to))                  
                                                            <button style="border: none" data-toggle="modal" data-target="#inspection{{$loop->iteration}}">
                                                                <i class="mdi mdi-magnify"></i>  {!! $status !!}
                                                            </button>
                                                        ...
                                                        @elseif($item->status_id == 7 && $item->ability_confirm == null)  
                                                           ...
                                                           <button style="border: none" data-toggle="modal"
                                                            ...
                                                            @php
                                                                ...
                                                                $applicant= $item->certificate_export_to->certiIB;
                                                                // dd($applicant);
                                                                $id= $loop->iteration;
                                                                $tracking = $item;
                                                            @endphp
                                                            
                                                             @include ('certify.tracking-ib.modal.modalstatus_ability_confirm')                                                                  
...
@push('js')
    ...
    $('#agree_doc_review_team').click(function(){
        ...
        $.ajax({
        url: "{{route('tracking.update_ib_doc_review_team')}}",
    ...
    $('#show_tracking_doc_review_auditor').click(function(){
        ...
        $.ajax({
            url: "{{route('tracking.get_ib_doc_review_auditor')}}",
            method: "POST",
            data: {
                trackingId: trackingId,
                _token: _token
