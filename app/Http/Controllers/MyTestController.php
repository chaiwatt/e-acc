...
class MyTestController extends Controller
{
   ...
   public function showLabCalDetails()
    ...
    public function showCbIsicDetails()
    {
        $templateType = "cb"; // กำหนด templateType เป็น "cb"
    ...
    public function downloadHtmlTemplate(Request $request)
    {
        ...
        if($templateType == "lab_test" || $templateType == "lab_cal")
        {

        }else if($templateType == "cb")
        {

        }else if($templateType == "ib")
        {
   ...
   function getCurrentFiscalYearData()
{
  ...
  // dd("dfsdf");
    CertificateHistory::where("app_no","RQ-LAB-68-041")->delete();
  ...
  public function checkLabRecord()
  {
    ...
    public function exportLabScopePdf()
  {
    $certilab = CertiLab::latest()->first();
